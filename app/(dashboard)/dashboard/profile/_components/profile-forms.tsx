    ...
    <div className="flex flex-col gap-6">
          ...
          <div className="flex-1">
            <GlobalForm
              ...
              defaultValues={{
                ...
                email: "alexander.vance@aurastudy.com",
                bio: "Masters student focused on Cognitive Psychology and Adaptive Learning Systems.",
              }}
              onSubmit={(v) => console.log(v)}
              submitText={null} // We rely on global save button visually acting for all forms
      ...
      <div className="rounded-2xl border border-border/50 bg-card p-6 md:p-8 shadow-sm">
        ...
        <GlobalForm
          ...
          defaultValues={{
            primaryMethod: "Pomodoro Technique",
            weeklyGoal: "30 Hours",
          }}
        ...
        <GlobalForm
          ...
          fields={[
            ...
            },
            {
              ...
              label: "",
              render: ({ field }) => (
                <div className="col-span-1 md:col-span-3 mt-4 rounded-xl border border-border/60 bg-muted/20 p-5 flex items-center justify-between">
